							...
							items: [
								{
									...
									id: 1,
									messages: [
										new Message(`fabricio`, `o ma, ca ben`, '12: 44', '12: 53'),
										new Message(`mary`, `po rri, ca do bej`, '12: 55'),
										new Message(`fabricio`, `e mbarove punen ??`, '12: 55', '13: 02'),
										new Message(`mary`, `ja, edhe nje cik kam`, '13: 14'),
										new Message(`fabricio`, `po mir pastaj, mbaroje`, '13: 15', '13: 20')
									],
									newMessage: ''
								},
								{
